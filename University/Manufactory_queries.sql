...
/* 14 !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!*/
SELECT DISTINCT SPJ1.ItemID AS One, SPJ2.ItemID AS Two
FROM SPJ AS SPJ1, SPJ AS SPJ2
WHERE SPJ1.ProviderID NOT IN(
	SELECT SPJ.ProviderID FROM SPJ
	WHERE SPJ.ItemID = SPJ2.ItemID
	) AND
